...
@Data
public class CategoryCriteria implements CriteriaDTO<String> {
    @JsonIgnore
    private static PredicateMapperStrategy<String> predicateMapperStrategy = new StringPredicateMapperStrategy();
    @NotNull
